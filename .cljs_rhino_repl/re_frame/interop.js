...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__51129 = cljs.core.instance_QMARK_;
var expr__51130 = reactive_val;
if(cljs.core.truth_(pred__51129.call(null,reagent.ratom.RAtom,expr__51130))){
return "ra";
} else {
if(cljs.core.truth_(pred__51129.call(null,reagent.ratom.RCursor,expr__51130))){
return "rc";
} else {
if(cljs.core.truth_(pred__51129.call(null,reagent.ratom.Reaction,expr__51130))){
return "rx";
} else {
if(cljs.core.truth_(pred__51129.call(null,reagent.ratom.Track,expr__51130))){
return "tr";
} else {
return "other";
}
