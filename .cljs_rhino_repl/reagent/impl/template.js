...
var G__50983 = o;
(G__50983[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__50984__delegate = function (args){
...
while (G__50985__i < G__50985__a.length) {G__50985__a[G__50985__i] = arguments[G__50985__i + 0]; ++G__50985__i;}
  args = new cljs.core.IndexedSeq(G__50985__a,0,null);
} 
return G__50984__delegate.call(this,args);};
G__50984.cljs$lang$maxFixedArity = 0;
G__50984.cljs$lang$applyTo = (function (arglist__50986){
var args = cljs.core.seq(arglist__50986);
return G__50984__delegate(args);
});
...
var G__50987 = o;
(G__50987[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__50988__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__50988 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50989__i = 0, G__50989__a = new Array(arguments.length -  0);
while (G__50989__i < G__50989__a.length) {G__50989__a[G__50989__i] = arguments[G__50989__i + 0]; ++G__50989__i;}
  args = new cljs.core.IndexedSeq(G__50989__a,0,null);
} 
return G__50988__delegate.call(this,args);};
G__50988.cljs$lang$maxFixedArity = 0;
G__50988.cljs$lang$applyTo = (function (arglist__50990){
var args = cljs.core.seq(arglist__50990);
return G__50988__delegate(args);
});
G__50988.cljs$core$IFn$_invoke$arity$variadic = G__50988__delegate;
return G__50988;
})()
;
} else {
...
var G__50992 = props;
var G__50992__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__50992,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50992);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__50992__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__50993){
...
var props = map__50994__$1;
var class$ = cljs.core.get.call(null,map__50994__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__50994,map__50994__$1,props,class$){
return (function (c){
...
});})(map__50994,map__50994__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50996){
var map__50997 = p__50996;
var map__50997__$1 = ((((!((map__50997 == null)))?(((((map__50997.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50997.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50997):map__50997);
var on_write = cljs.core.get.call(null,map__50997__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__50997,map__50997__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__50997,map__50997__$1,on_write))
);
} else {
...
var G__51000 = jsprops;
(G__51000["defaultValue"] = value);

(G__51000["onChange"] = ((function (G__51000,v,value,on_change){
return (function (p1__50999_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__50999_SHARP_);
});})(G__51000,v,value,on_change))
);
...
var vec__51003 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__51003,(0),null);
var id = cljs.core.nth.call(null,vec__51003,(1),null);
var class$ = cljs.core.nth.call(null,vec__51003,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___51007 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___51007 == null)){
} else {
var key_51008 = temp__5461__auto___51007;
...
var temp__5461__auto___51009 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___51009 == null)){
} else {
var key_51010 = temp__5461__auto___51009;
reagent.impl.template.oset.call(null,jsprops,"key",key_51010);
}
...
var G__51011 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__51011["name"] = c);
...
var len__4499__auto___51016 = arguments.length;
var i__4500__auto___51017 = (0);
while(true){
if((i__4500__auto___51017 < len__4499__auto___51016)){
args__4502__auto__.push((arguments[i__4500__auto___51017]));

var G__51018 = (i__4500__auto___51017 + (1));
i__4500__auto___51017 = G__51018;
continue;
} else {
}
break;
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51015,seq51014__$1);
});
...
break;
default:
var G__51021 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__51021;
continue;
...
var n__4376__auto___51023 = a.length;
var i_51024 = (0);
while(true){
if((i_51024 < n__4376__auto___51023)){
(a[i_51024] = reagent.impl.template.as_element.call(null,(a[i_51024])));

var G__51025 = (i_51024 + (1));
i_51024 = G__51025;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___51026 = a.length;
var i_51027 = (0);
while(true){
if((i_51027 < n__4376__auto___51026)){
var val_51028 = (a[i_51027]);
if(((cljs.core.vector_QMARK_.call(null,val_51028)) && ((reagent.impl.template.key_from_vec.call(null,val_51028) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_51027] = reagent.impl.template.as_element.call(null,val_51028));

var G__51029 = (i_51027 + (1));
i_51027 = G__51029;
continue;
} else {
}
...
var ctx = ({});
var vec__51030 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__51030,(0),null);
var derefed = cljs.core.nth.call(null,vec__51030,(1),null);
...
var G__51033 = (cljs.core.count.call(null,argv) - first_child);
switch (G__51033) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__51033){
