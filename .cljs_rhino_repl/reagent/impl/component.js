...
if((i < len)){
var k = (ks[i]);
var G__50936 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__50937 = (i + (1));
m = G__50936;
i = G__50937;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__50939 = c;
var G__50939__$1 = (((G__50939 == null))?null:G__50939.prototype);
if((G__50939__$1 == null)){
return null;
} else {
return (G__50939__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__50941 = c;
var G__50941__$1 = (((G__50941 == null))?null:G__50941.prototype);
if((G__50941__$1 == null)){
return null;
} else {
return (G__50941__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__50944__delegate = function (args){
...
while (G__50945__i < G__50945__a.length) {G__50945__a[G__50945__i] = arguments[G__50945__i + 0]; ++G__50945__i;}
  args = new cljs.core.IndexedSeq(G__50945__a,0,null);
} 
return G__50944__delegate.call(this,args);};
G__50944.cljs$lang$maxFixedArity = 0;
G__50944.cljs$lang$applyTo = (function (arglist__50946){
var args = cljs.core.seq(arglist__50946);
return G__50944__delegate(args);
});
...
var _STAR_current_component_STAR_50948 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_50948;
}});
...
return ((function (G__50949,G__50949__$1){
...
var c = this;
var G__50954_50956 = (c["cljsRatom"]);
if((G__50954_50956 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__50954_50956);
}
...
var renders_50958 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_50959 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_50958));
if((cljs.core.count.call(null,renders_50958) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_50958))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_50959)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_50959))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__50957 = name;
switch (G__50957) {
case "":
...
var G__50961 = o;
(G__50961[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__50962 = fiber;
var G__50962__$1 = (((G__50962 == null))?null:(G__50962["type"]));
if((G__50962__$1 == null)){
return null;
} else {
return (G__50962__$1["displayName"]);
}
})();
var parent = (function (){var G__50963 = fiber;
if((G__50963 == null)){
return null;
} else {
return (G__50963["return"]);
}
})();
var path = (function (){var G__50964 = parent;
var G__50964__$1 = (((G__50964 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__50964));
if((G__50964__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50964__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__50966 = c;
if((G__50966 == null)){
return null;
} else {
return (G__50966["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__50967._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__50969 = c;
if((G__50969 == null)){
return null;
} else {
return (G__50969["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__50971 = c;
if((G__50971 == null)){
return null;
} else {
return G__50971._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__50973 = instance;
if((G__50973 == null)){
return null;
} else {
return (G__50973["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__50974 = instance;
if((G__50974 == null)){
return null;
} else {
return G__50974._currentElement;
}
}
})();
var name = (function (){var G__50975 = elem;
var G__50975__$1 = (((G__50975 == null))?null:(G__50975["type"]));
if((G__50975__$1 == null)){
return null;
} else {
return (G__50975__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__50977 = elem;
if((G__50977 == null)){
return null;
} else {
return (G__50977["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__50978._owner;
}
}
})();
var path = (function (){var G__50979 = owner;
var G__50979__$1 = (((G__50979 == null))?null:reagent.impl.component.component_path.call(null,G__50979));
if((G__50979__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50979__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__50980 = c;
var G__50980__$1 = (((G__50980 == null))?null:G__50980.constructor);
if((G__50980__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__50980__$1);
}
}
})();
